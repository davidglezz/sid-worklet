...
export function playSID(sidurl, subtune) {
...
export function jsSID(samplerate, background_noise) {
  ...
  this.loadinit = function (sidurl, subt) {
    ...
    request.onload = () => {
      this.load(request.response, subt);
    };
